...
var i = (e2, i2) => {
  for (var a2 in i2 || (i2 = {}))
    t.call(i2, a2) && o(e2, a2, i2[a2]);
  if (s)
    for (var a2 of s(i2))
      r.call(i2, a2) && o(e2, a2, i2[a2]);
  return e2;
};
var n = (e2) => void 0 === e2;
...
var g = class {
  ...
  keys() {
    return Object.keys(this).filter((e2) => !g.ignore.includes(e2));
  }
  startProcessing() {
  ...
  reset() {
    Object.keys(this).filter((e2) => !g.ignore.includes(e2)).forEach((e2) => {
  ...
  submit(e2, t2, s2 = {}) {
    return this.startProcessing(), s2 = i({ data: {}, params: {}, url: this.route(t2), method: e2, onUploadProgress: this.handleUploadProgress.bind(this) }, s2), "get" === e2.toLowerCase() ? s2.params = i(i({}, this.data()), s2.params) : (s2.data = i(i({}, this.data()), s2.data), p(s2.data) && !s2.transformRequest && (s2.transformRequest = [(e3) => h.serialize(e3)])), new Promise((e3, t3) => {
      (g.axios || import_axios.default).request(s2).then((t4) => {
  ...
  extractErrors(e2) {
    return e2.data && "object" == typeof e2.data ? e2.data.errors ? i({}, e2.data.errors) : e2.data.message ? { error: e2.data.message } : i({}, e2.data) : { error: g.errorMessage };
  }
  ...
  route(e2, t2 = {}) {
    let s2 = e2;
    return Object.prototype.hasOwnProperty.call(g.routes, e2) && (s2 = decodeURI(g.routes[e2])), "object" != typeof t2 && (t2 = { id: t2 }), Object.keys(t2).forEach((e3) => {
...
// dep:vform
var vform_default = vform_es_default;
export {
  y as Errors,
  g as Form,
  vform_default as default
};
